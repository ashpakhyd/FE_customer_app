              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <span className="text-gray-400 line-through text-sm">{redemptionData.offer.price.currency} {offerData.price.original}</span>
                      <span className="text-yellow-600 font-bold text-xl ml-2">{redemptionData.offer.price.currency} {offerData.price.discounted}</span>
                    </div>
                  </div>
