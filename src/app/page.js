                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-2">
                          <span className="text-sm line-through text-black opacity-60">{redemptionData.offer.price.currency} {offer.price.original}</span>
                          <span className="text-lg font-bold text-black">{redemptionData.offer.price.currency} {offer.price.discounted}</span>
                        </div>
                      </div>
